...
it is strongly encouraged NOT to use this type of scoping. These constraints lead to types of the form 
```(?x::t') => t ```, which says "this function uses a dynamically-bound variable ?x of type t' "
